...
<div class="card card-default">
    <div class="card-header">
        <div class="card-tools">
            <div class="btn-group">
                <a href="<?= route_to('user/manage/new') ?>" class="btn btn-sm btn-block btn-primary"><i class="fa fa-plus"></i>
...
<script>
                ...
                "data": function(data) {
                    return `<td class="text-right py-0 align-middle">
                            <div class="btn-group btn-group-sm">
                                <a href="<?= route_to('user/manage') ?>/${data.id}/edit" class="btn btn-primary btn-edit"><i class="fas fa-pencil-alt"></i></a>
    ...
    $(document).on('click', '.btn-delete', function(e) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: `<?= route_to('user/manage') ?>/${$(this).attr('data-id')}`,
                    method: 'DELETE',
