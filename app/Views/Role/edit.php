<!-- Include duallistbox-->
<?= $this->include('App\Views\load\duallistbox') ?>
        ...
        <div class="card card-outline card-info">
            <div class="card-header">
                <div class="float-left">
                    <div class="btn-group">
                        <a href="<?= base_url('role') ?>" class="btn btn-sm btn-block btn-secondary"><i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="<?= base_url('role/' . $role->id) ?>/update" method="post">
                    <?= csrf_field() ?>
