        ...
        <div class="card">
            <div class="card-header">
                <div class="float-right">
                    <div class="btn-group">
                        <a href="<?= route_to('role/new') ?>" class="btn btn-sm btn-block btn-primary"><i class="fa fa-plus"></i>
                ...
                "data": function(data) {
                    return `<td class="text-right py-0 align-middle">
                            <div class="btn-group btn-group-sm">
                                <a href="<?= route_to('role') ?>/${data.id}/edit" class="btn btn-primary btn-edit"><i class="fas fa-pencil-alt"></i></a>
    ...
    $(document).on('click', '.btn-delete', function(e) {
        Swal.fire({
            ...
            .then((result) => {
                if (result.value) {
                    $.ajax({
                        url: `<?= route_to('role') ?>/${$(this).attr('data-id')}`,
                        method: 'DELETE',
